...
class ParentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parent" do
    assert_difference('Parent.count') do
      post parents_url, params: { parent: { email: @parent.email, name: @parent.name, phone: @parent.phone } }
    end
  ...
  test "should update parent" do
    patch parent_url(@parent), params: { parent: { email: @parent.email, name: @parent.name, phone: @parent.phone } }
